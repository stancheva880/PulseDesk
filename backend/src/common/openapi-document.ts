...
const TAGS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Tenants', "Clubs and schools. SUPER_ADMIN only, except the club's own shared payment-details pair, which ADMIN runs too."],
  ['Users', 'Staff and customer accounts, their roles and location assignments.'],
  ['Locations', "Venues within a tenant. Writes are SUPER_ADMIN only, except the payment-details pair, which ADMIN runs too, scoped to their own assigned locations."],
  ...
  ['CustomerLocations', "The family's own locations, with payment details resolved against the club's shared default — for the portal."],
